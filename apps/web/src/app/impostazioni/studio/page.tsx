...
export default async function PaginaStudio() {
  ...
  const studio: DatiStudio | null = risposta === null || 'errore' in risposta ? null : risposta;
    ...
    <div className="grid gap-6 lg:grid-cols-[minmax(0,32rem)_minmax(0,1fr)]">
      <section>
        ...
        <p className="mb-4 text-sm leading-relaxed text-testo-tenue">
          Intesta i report consegnati ai clienti. Finché non è compilata, il documento esce senza
          intestazione.
        </p>
      ...
      <Scheda className="h-fit text-sm leading-relaxed text-testo-tenue">
        ...
        <ul className="mt-2 space-y-1.5">
          <li>
            Il report è un documento <strong>dello studio</strong>, non dell&apos;attrezzo con cui è stato
            scritto: chi lo riceve deve sapere chi lo ha redatto.
          </li>
          <li>
            Il Reg. IVASS 40/2018 richiede che i documenti consegnati al contraente identifichino
            l&apos;intermediario e la sua iscrizione al RUI.
          </li>
          <li>
            I dati valgono per l&apos;intero studio: ogni collaboratore che stampa un report usa questa
            intestazione.
          </li>
        </ul>
      </Scheda>
