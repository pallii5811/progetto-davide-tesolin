    ...
    <>
      {andamento.length > 0 && (
        <>
          ...
          {/*
            La tabella scorre dentro il suo riquadro, invece di trascinare la pagina.

            Misurata a 390 pixel: arriva a 420, e faceva scorrere in orizzontale l'intero
            report — il documento che l'intermediario apre dal telefono davanti al cliente.
            In stampa non cambia nulla: sull'A4 la larghezza utile è più che doppia, la
            tabella ci sta, e non c'è alcun contenuto da far scorrere.
          */}
      ...
      {schema !== null && (
        <>
          ...
          {/* Stessa ragione della tabella qui sopra. */}
          <div className="overflow-x-auto">
