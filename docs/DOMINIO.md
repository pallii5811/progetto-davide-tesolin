...
Danno probabile = Valore dei beni
                × quota di combustibilità del settore   (ATECO, 0,60 – 0,95)
...
la confidenza scende, con l'indicazione di quale domanda l'abbasserebbe.
...
**Soglie.** Controllo: quota *superiore* al 50% — metà esatta non è maggioranza, e due soci al
...
**Cariche.** L'anagrafica estesa **non le contiene**. Non si deducono: si dichiara che mancano e
si generano le domande da porre in intervista. Dalla carica dipende chi è assicurato dalla D&O,
e un amministratore ipotizzato finirebbe su un documento contrattuale.
